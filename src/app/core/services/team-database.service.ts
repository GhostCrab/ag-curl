...
export class TeamDatabaseService {
    private teams: ITeam[] = [
        ...
        new Team('Canada',             'CAN', 'C', 7,   5000, 'https://flagsapi.com/CA/shiny/64.png'),
        ...
        new Team('Italy',              'ITA', 'A', 11,  8000, 'https://flagsapi.com/IT/shiny/64.png'),
        new Team('Netherlands',        'NED', 'A', 12, 10000, 'https://flagsapi.com/NL/shiny/64.png'),
        new Team('Panama',             'PAN', 'A', 13, 10000, 'https://flagsapi.com/PA/shiny/64.png'),
        new Team('Chinese Taipei',     'TPE', 'A', 14, 20000, 'https://flagsapi.com/TW/shiny/64.png'),
        new Team('Great Britain',      'GBR', 'C', 15, 25000, 'https://flagsapi.com/GB/shiny/64.png'),
        new Team('Israel',             'ISR', 'D', 16, 25000, 'https://flagsapi.com/IL/shiny/64.png'),
        new Team('Australia',          'AUS', 'B', 17, 25000, 'https://flagsapi.com/AU/shiny/64.png'),
        new Team('Czechia',            'CZE', 'B', 18, 40000, 'https://flagsapi.com/CZ/shiny/64.png'),
